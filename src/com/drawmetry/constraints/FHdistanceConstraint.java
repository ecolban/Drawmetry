 ...
 * @author  Erik Colban
 */
public class FHdistanceConstraint extends Constraint {

    private PointVar pred1,  pred2;
    private NumVar target;

    /** Creates a new instance of FHdistanceConstraint */
    public FHdistanceConstraint() {
    }
    ...
    public void setPreds(int i, DmEntity e) {
        if (i < 0 || i > 1 ||
            ...
            throw new IllegalArgumentException("Problems adding hdistance constraint on " + target);
        }
        switch (i) {
            case 0:
                pred1 = (PointVar) e;
    ...
    public void fire() {
        if (pred1 != null && pred2 != null) {
            target.nValue = -pred1.x + pred2.x;
        }
    }

    public String toString() {
        return "hdistance(" + pred1.getEntityID() + "," + pred2.getEntityID() + ")";
    }
