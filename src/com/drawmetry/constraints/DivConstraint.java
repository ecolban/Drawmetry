 ...
 * @author  Erik Colban
 */
public class DivConstraint extends Constraint {

    private NumVar pred1,  pred2;
    private NumVar target;

    /** Creates a new instance of DivConstraint */
    public DivConstraint() {
    }
    ...
    public void fire() {
        if (pred1 != null && pred2 != null && pred2.nValue != 0.0) {
    ...
    public String toString() {
        ...
        a = pred1.toString();
        b = pred2.toString();
        if (pred1.precedence < 1) {
            a = "(" + a + ")";
        }
        if (pred2.precedence <= 1) {
            b = "(" + b + ")";
        }
        return a + " / " + b;
    }
