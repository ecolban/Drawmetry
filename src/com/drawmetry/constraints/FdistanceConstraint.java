 ...
 * @author  Erik Colban
 */
public class FdistanceConstraint extends Constraint {
    
    private PointVar pred1, pred2;
    private NumVar target;
    
    /** Creates a new instance of FdistanceConstraint */
    public FdistanceConstraint() {
    }
    ...
    public void fire() {
        if (pred1 != null && pred2 != null) {
            double a = pred1.x - pred2.x;
            double b = pred1.y - pred2.y;
            target.nValue = sqrt(a*a + b*b);
        }
    }
    
    public String toString() {
        return "distance(" + pred1.getEntityID() + "," + pred2.getEntityID() + ")";
    }
