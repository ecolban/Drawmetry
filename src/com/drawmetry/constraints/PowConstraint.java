 ...
 * @author  Erik Colban
 */
public class PowConstraint extends Constraint {

    private NumVar pred1,  pred2;
    private NumVar target;

    /** Creates a new instance of PowConstraint */
    public PowConstraint() {
    }
    ...
    public void fire() {
        if (pred1 != null && pred2 != null) {
            double aux = Math.pow(pred1.nValue, pred2.nValue);
            if (!Double.isNaN(aux)) {
                target.nValue = aux;
            }
        }
    ...
    public String toString() {
        ...
        a = pred1.toString();
        b = pred2.toString();
        if (pred1.precedence < 2) {
            a = "(" + a + ")";
        }
        if (pred2.precedence < 2) {
            b = "(" + b + ")";
        }
        return a + " ^ " + b;
    }
